...
if (isset($_POST['btn-signup'])) {
    ...
    $result = $client->call('WS1.registerStudent', array('uname' => $uname, 'email' => $email, 'gender' => $gender, 'upass' => $upass));
...
<html>
    ...
    <body>
        ...
        <div class="col-sm-4">
            <form class="form-signin" action="register-student.php" method="post" id="register-form">
