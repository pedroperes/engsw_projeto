...
class WS1 {
    ...
    public $server = null;
    public $namespace = "http://localhost/engsw/proj_pedroperes30075_jorgegodinho29814/class.WS1.php";
    ...
    public function __construct() {
        ...
        $this->server->register(
            ...
            'upass' => 'xsd:string'), // input parameters
                ...
                'urn:ws1wsdl#registerstudent', // soapaction
                'rpc', // style
                'encoded', // use
        ...
        $this->server->register(
            ...
            'day' => 'xsd:int', // input parameters
            'start_hour' => 'xsd:string', // input parameters
            'duration' => 'xsd:int'), // input parameters
                array('return' => 'xsd:string'), // output parameters
                'urn:ws1wsdl', // namespace
