...
if (isset($_POST['btn-login'])) {
    ...
    $query = $DBcon->query("SELECT id, email, password FROM instructor WHERE email='$email'");
    ...
    if (password_verify($password, $row['password']) && $count == 1) {
        ...
        header("Location: home-instructor.php"); // Senão entra na página de utilizador normal
            ...
            <div class="signin-form">
                <form class="form-signin" method="post" id="login-form">
                    ...
                    <div class="form-group">
                        ...
                        <a href="index.php" class="btn btn-default" style="float:right;">Login Aluno</a>
