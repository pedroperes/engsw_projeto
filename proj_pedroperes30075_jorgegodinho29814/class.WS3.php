...
class WS3 {
    ...
    public $server = null;
    public $namespace = "http://localhost/engsw/proj_pedroperes30075_jorgegodinho29814/class.WS3.php";
...
// ------------------------------------------------------------------------- //
    ...
    function updateStudent($nome, $gender, $email, $id) {
        $a = new Aluno();
        return $a->updateStudent($nome, $gender, $email, $id);
    }
