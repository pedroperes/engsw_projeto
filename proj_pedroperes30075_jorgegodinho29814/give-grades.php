    ...
    <body>
        ...
        <div class="col-sm-4">
            <form class="form-signin" method="post" id="register-form">
                <h2 class="form-signin-heading">Lançar notas</h2><hr />
                <?php
                if (isset($msg)) {
                    echo $msg;
                }
                ?>
                <label for="selectStudent">Selecionar Aluno: </label>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Nota" name="grade" required  />
                </div>
